...
const ThemeToggle = () => {
    ...
    return (
        <div className='relative xl:ml-12 md:ml-20 w-[52px] h-8 flex items-center border-2 drop-shadow-2xl bg-white dark:bg-slate-900 cursor-pointer rounded-full p-1 duration-300 overflow-hidden' onClick={() => setDarkMode(!darkMode)}>
