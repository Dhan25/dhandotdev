...
const ProjectCards = () => {
  ...
  return (
    <section className="mt-12">
      <div className="relative grid md:grid-cols-2 items-center justify-center md:px-24 md:gap-6 gap-5 xl:px-44 p-4">

        {/* Uber Clone */}
        <div className="border-2 shadow-xl rounded-xl w-full h-fit p-3" data-aos='fade-down' data-aos-delay='500'>
          <img src={uberClone} alt="" className="w-full object-cover p-2 h-40 rounded-xl hover:scale-105 duration-300" />
        ...
        {/* Personal Portfolio */}
        <div className="border-2 shadow-xl rounded-xl w-full h-fit p-3" data-aos='fade-left' data-aos-delay='500'>
          <img src={personalPortfolio} alt="" className="w-full object-cover p-2 h-40 rounded-xl hover:scale-105 duration-300" />
          <h1 className="mt-2 font-bold ml-2 dark:text-white">First Personal Portfolio</h1>
          <div className="px-2 text-xs flex items-center mt-2">
            <p className="text-xs font-bold dark:text-white">Tech use:</p>
            <div className="ml-3 flex items-center gap-2 ">
              <span className="border px-1.5 py-0.5 rounded-full font-medium text-tertiary dark:text-white">react</span>
              <span className="border px-1.5 py-0.5 rounded-full font-medium text-tertiary dark:text-white">css</span>
            </div>
          </div>
          <div className="flex items-center justify-between px-2 mt-3 pb-2">
        ...
        {/* Food Website */}
        <div className="border-2 shadow-xl rounded-xl w-full h-fit p-3" data-aos='fade-up' data-aos-delay='500'>
          <img src={foodWebsite} alt="" className="w-full object-cover p-2 h-40 rounded-xl hover:scale-105 duration-300" />
        ...
        {/* Weather app */}
        <div className="border-2 shadow-xl rounded-xl w-full h-fit p-3" data-aos='fade-up' data-aos-delay='500'>
          <img src={weatherBg} alt="" className="w-full object-contain bg-no-repeat p-2 h-40 rounded-xl hover:scale-105 duration-300" />
        ...
        {/* Disney Clone */}
        <div className="border-2 shadow-xl rounded-xl w-full h-fit p-3" data-aos='fade-up' data-aos-delay='500'>
          <img src={disneyCLone} alt="" className="w-full object-cover bg-no-repeat p-2 h-40 rounded-xl hover:scale-105 duration-300" />
          <h1 className="mt-2 font-bold ml-2 dark:text-white">Disney plus Clone</h1>
          <div className="px-2 text-xs flex items-center mt-2">
            <p className="text-xs font-bold dark:text-white">Tech use:</p>
            <div className="ml-3 flex items-center gap-2">
              <span className="border px-1.5 py-0.5 rounded-full font-medium text-tertiary dark:text-white">vite</span>
              <span className="border px-1.5 py-0.5 rounded-full font-medium text-tertiary dark:text-white">react</span>
              <span className="border px-1.5 py-0.5 rounded-full font-medium text-tertiary dark:text-white">tailwind css</span>
              <span className="border px-1.5 py-0.5 rounded-full font-medium text-tertiary dark:text-white">TMBD API</span>
            </div>
          </div>

          <div className="flex items-center justify-between px-2 mt-3 pb-2">
            <a href="https://disney-clone-1gqr.vercel.app/" target="https://disney-clone-1gqr.vercel.app/"
              className="group flex items-center text-xs text-tertiary dark:text-white">Demo <span><RiArrowRightLine className="h-3 ml-1 group-hover:translate-x-2 transition duration-300 ease-out" /></span></a>
            <a href="https://github.com/Dhan25/Disney-Clone" target="https://github.com/Dhan25/Disney-Clone" className="flex items-center text-xs text-tertiary mr-1 dark:text-white hover:text-gray-400 duration-300">Code <FaGithub size={14} className="ml-2" /></a>
          </div>
        </div>
