    ...
    <section className="mt-12">
      <div className="grid md:grid-cols-2 items-center justify-center xl:px-40 md:px-24 gap-12">
        ...
        <div className="border-2 shadow-xl rounded-xl w-72 h-60">
          ...
          <h1 className="mt-2 font-bold ml-2">Uber Clone Inc. Clone</h1>
          <div className="flex items-center justify-between px-2 mt-2">
            <a href="https://uber-technologies-clone.vercel.app" target="https://uber-technologies-clone.vercel.app"
              className="group flex items-center text-xs text-tertiary">Demo <span><RiArrowRightLine className="h-3 ml-1 group-hover:translate-x-2 transition duration-300 ease-out" /></span></a>
            <button onClick={() => openModalWithContent(
              ...
              )} className="flex text-xs text-tertiary mr-1"> View <BsBoxArrowUpRight className="h-3 ml-2" />
            </button>
        ...
        <div className="border-2 shadow-xl rounded-xl w-72 h-60">
          ...
          <h1 className="mt-2 font-bold ml-2">Personal Portfolio</h1>
          <div className="flex items-center justify-between px-2 mt-2">
            ...
            )} className="flex text-xs text-tertiary mr-1"> View <BsBoxArrowUpRight className="h-3 ml-2" /></button>
        ...
        <div className="border-2 shadow-xl rounded-xl w-72 h-60">
          ...
          <h1 className="mt-2 font-bold ml-2">Food Website</h1>
          <div className="flex items-center justify-between px-2 mt-2">
