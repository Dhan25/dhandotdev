...
const About = () => {
  return (
    <div
      id="about"
      className="bg-white w-full h-fit xl:pt-24 xl:px-64 xl:pb-36 dark:bg-slate-900"
    >
      <div className="pt-28 px-8">
        <div
          className="relative grid grid-rows-1 md:grid-cols-1 md:justify-items-center xl:flex gap-6"
          data-aos="fade-down"
          data-aos-delay="400"
        >
          <img
          ...
          <div
            className="flex flex-col text-center xl:text-left md:px-8 pb-20"
            data-aos="fade-down"
            data-aos-delay="400"
          >
            <h1 className="dark:text-white text-primary font-extrabold text-[1.2rem]">
            ...
            <div
              className="md:mt-6 overflow-hidden"
              data-aos="fade-up"
              data-aos-delay="500"
            >
